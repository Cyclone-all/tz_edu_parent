...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir("E:\\course\\code\\tz_edu_parent\\tz_edu_service\\src\\main\\java");
        globalConfig.setAuthor("BaiYun");
        //生成后是否打开资源管理器
        ...
        packageConfig.setParent("com.tuzhong.edu");
